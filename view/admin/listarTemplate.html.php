                ...
                <div class="accordion-content" id="cliente">
                    ...
                    <div class="col-md-12" id="columna3" style="background-color:rgba(128, 128, 128, 0.51);">
                        ...
                        <div class="col-md-2">
                            ...
                            <input class="file" id="file1" type='file'  title="test #1"/>
                            <div id="prev_file1"></div><br/>
                        </div>
                        
                        <div class="col-md-2">
                            <label>imagen 2</label>       
                            <input class="file" id="file2" type='file'  title="test #2"/>
                            <div id="prev_file2"></div>
                        </div>     
                        
                        <div class="col-md-2">
                            <label>imagen 3</label>   
                            <input class="file" id="file3" type='file'  title="test #3"/>
                            <div id="prev_file3"></div>
                        </div> 
                        
                        <div class="col-md-2">
                            <label>imagen 4</label>   
                            <input class="file" id="file4" type='file'  title="test #4"/>
                            <div id="prev_file4"></div>
                        </div> 
                        
                        <div class="col-md-2">
                            <label>imagen 5</label>   
                            <input class="file" id="file5" type='file'  title="test #5"/>
