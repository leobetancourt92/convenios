                ...
                <div class="accordion-content">
                    ...
                    <div class="col-md-6" id="columna1">
                        ...
                        <div class="form-group">
                            <label>NIT</label>
                            <input type="text" class="form-control" name="<?php echo clienteTableClass::getNameField(clienteTableClass::NIT, true) ?>" value="<?php echo ((isset($objListar) == true) ? $objListar[0]->$nit : '') ?>"/>
                        </div>

                        <div class="form-group">
                            <label>Razón Social</label>
                            <input type="text" class="form-control" name="<?php echo clienteTableClass::getNameField(clienteTableClass::RAZON_SOCIAL, true) ?>" value="<?php echo ((isset($objListar) == true) ? $objListar[0]->$razon : '') ?>" />
                        </div>

                        <div class="form-group">
                            <label>Código del plan</label>
                            <input id="selectbasic"  class="form-control" name="<?php echo clienteTableClass::getNameField(clienteTableClass::CODIGO_PLAN, true) ?>" value="<?php echo ((isset($objListar) == true) ? $objListar[0]->$codigo_plan : '') ?>"  />

                        </div>

                        <div class="form-group">
                            <label>Nombre del Plan</label>
                            <input type="text" class="form-control" name="<?php echo clienteTableClass::getNameField(clienteTableClass::NOMBRE_PLAN, true) ?>" value="<?php echo ((isset($objListar) == true) ? $objListar[0]->$nombre_plan : '') ?>" />
                        </div>
