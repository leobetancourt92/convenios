...
namespace mvc\validator {
   ...
   */
  class createClienteValidatorClass extends validatorClass {

    public static function validateInsert() {
      $flag = false;
      
      
      if (self::notBlank(request::getInstance()->getPost(clienteTableClass::getNameField(clienteTableClass::NIT,TRUE)))) {
        $flag = true;
       session::getInstance()->setFlash(clienteTableClass::getNameField(clienteTableClass::NIT), true);
        session::getInstance()->setError('El campo nit es requerido', clienteTableClass::getNameField(clienteTableClass::NIT,TRUE));
      }
